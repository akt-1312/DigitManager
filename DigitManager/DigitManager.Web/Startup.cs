...
using DigitManager.Web.Handlers;
...
namespace DigitManager.Web
{
    public class Startup
    {
        ...
        {           
            ...
            services.AddHttpClient<ILoginUserService, LoginUserService>(client =>
            {
                client.BaseAddress = new Uri("https://localhost:44307/");
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            });
            services.AddHttpClient<IOwnerService, OwnerService>(client =>
            {
                client.BaseAddress = new Uri("https://localhost:44307/");
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            ...
            services.AddHttpClient<IDigitService, DigitService>(client =>
            {
                client.BaseAddress = new Uri("https://localhost:44307/");
                client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            }).AddHttpMessageHandler<ValidateHeaderHandler>();
